...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        // Create DataView filtering
        dvEmployees.RowFilter = "Country = 'Egypt' OR Country = 'Jordan'";

        Console.WriteLine("Printing data from DataView after filtering by country = Egypt or country = Jordan\n");
